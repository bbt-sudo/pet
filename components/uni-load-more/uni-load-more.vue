<template>
	...
	<!-- 		<view class="load1">
			...
			<view class="mix-loading-icon">
				<block v-if="icon=='cat'">
					<image src="@/static/images/common/cat.png" mode="widthFix"></image>
				</block>	
				<block v-else>
					<image src="@/static/images/common/dog.png" mode="widthFix"></image>
				</block>
			</view>
